...
export default function AdminNewProjectPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(error.message || 'Erreur lors de la creation');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="container mx-auto px-4 py-8 max-w-3xl">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-2xl font-bold text-slate-800">Nouveau projet</h1>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              />
              <p className="text-xs text-gray-400 mt-1">Genere automatiquement a partir du titre</p>
            </div>
            ...
            <div>
              ...
              />
              <p className="text-xs text-gray-400 mt-1">Separees par des virgules</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Taille de l'equipe</label>
                <input
                  type="number"
                  name="team_size"
