            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-100">
                <tr>
                  ...
                  <th className="text-left text-xs font-medium text-gray-500 uppercase tracking-wider px-6 py-3">Catégorie</th>
                  <th className="text-left text-xs font-medium text-gray-500 uppercase tracking-wider px-6 py-3">Prix</th>
              ...
              <tbody>
                <tr>
                  <td colSpan={5} className="text-center text-gray-500 py-12">
                    ...
                    <p className="text-sm mt-1">Ajoutez des formations depuis l'admin Django</p>
                  </td>
                </tr>
              </tbody>
            </table>
